// A fixture review finding for the refuter case that is CLEARLY NOT a real issue:
...
// calls for exactly that extraction. A skeptical refuter reading the inline plan
// should return `verdict: 'refuted'` with low confidence that the gap is real.
