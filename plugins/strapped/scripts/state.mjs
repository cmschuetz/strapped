...
var yamlEngine = {
  parse: (input) => import_js_yaml.default.load(input) ?? {},
  stringify: (data) => import_js_yaml.default.dump(data, { flowLevel: 1, lineWidth: -1, condenseFlow: true })
};
...
function coerceValue(value) {
  let parsed;
  try {
    parsed = import_js_yaml.default.load(value);
  } catch {
    return value;
  }
